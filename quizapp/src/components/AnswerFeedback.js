...
export function AnswerFeedback(props) {
    ...
    return (
        <div className='p-3 col-6'>
            <h1 className="mb-5">Test results:</h1>
            {correctCount + '/' + props.data.passedQuestions.length} ({Math.round(correctCount/props.data.passedQuestions.length*100)}%)
                ...
                <div className='question'>
                    ...
                    {q.type === 'multiple_choice' || q.type === 'true_false' ? 
                        ...
                        : <div className="answerChoices">
                            <div>
                                Selected answer:
                                <input type="text" name={questionId} className='p-2' id={questionId} value={props.data.quizResults[questionId]} disabled/>
                            ...
                            <div>
                                Correct answer:
                                <input type="text" name={questionId} className='p-2' id={questionId} value={q.answer} disabled/>
                                <span className="text-success p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                    <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                                    </svg>
