...
export function AnswerFeedback(props) {
    ...
    return (
        <div className='p-3 col-6'>
            <h1 className="mb-5">Test results:
                <p>{correctCount + '/' + props.data.passedQuestions.length} 
                ({Math.round(correctCount / props.data.passedQuestions.length * 100)}%)</p> 
            </h1>
                            ...
                            <div className="answerChoices">
                                {props.data.quizResults[questionId] === q.answer_choices[a] ?
                                    <>
                                        ...
                                        disabled checked />
                                        <label htmlFor={a + '_' + questionId} className='p-2' style={{'fontWeight': 'bold', 'color': 
                                        q.answer_choices[a] === q.answer ? 'green' : 'red'}}>{q.answer_choices[a]}</label>
                                    </>
                                    :
                                    <>
