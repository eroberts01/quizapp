...
export function Navbar(props){
    ...
    return <nav className="navbar navbar-dark bg-dark text-light pb-3 pt-3">
            <div className="container-fluid">
                <Link className="nav-link navbar-brand" aria-current="page" to="/quizapp" reloadDocument><h3>SWE 632 Quiz App</h3></Link>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                        <Link className="nav-link active" aria-current="page" to="/quizapp" reloadDocument>Browse quizzes</Link>
                    </li>
                </ul>
